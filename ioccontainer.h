    ...
    //Далее идут классы, которые были реализованы для примера работы контейнера. Мы их комментируем, а используем классы из других файлов. Это обеспечивает низкую связность. Все файлы подключаем только в main
    /*
    class IAmAThing
    {
    public:
